...
export const PlannerLayout = () => {
  ...
  useEffect(() => {
    const checkCollapse = () => {
      const isCollapsed = localStorage.getItem('planner-sidebar-collapsed') === 'true';
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#090d16] text-slate-800 dark:text-slate-200 transition-colors duration-300">
      ...
      {/* Sidebar Navigation */}
      <PlannerSidebar mobileOpen={mobileOpen} setMobileOpen={setMobileOpen} />
